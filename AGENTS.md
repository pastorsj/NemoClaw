...
- Keep `packages/nemoclaw-hermes/config/generate-config.ts` as a thin build-time entrypoint; add Hermes env parsing, config construction, registry handling, and serialization beside it under `packages/nemoclaw-hermes/config/`
