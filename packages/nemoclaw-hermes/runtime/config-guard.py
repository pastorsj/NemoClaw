...
def checkout_state_guard_path() -> str:
    """Return the state guard path when this module runs from a source checkout."""
...
def _mutation_lock_owner_is_live(owner: dict[str, object]) -> bool:
    ...
    state_guard_names = {
        ...
        checkout_state_guard_path().encode("utf-8"),
    }
...
def run_state_dir_transition(
    ...
    checkout = checkout_state_guard_path()
