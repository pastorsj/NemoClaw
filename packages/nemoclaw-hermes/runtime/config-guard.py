...
# Keep this in parity with the generated Hermes config, environment, Fabric
# runner config, and hash files. The integration test protects this separate
# in-image recovery boundary.
