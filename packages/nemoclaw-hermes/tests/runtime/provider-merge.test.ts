...
// (packages/nemoclaw-hermes/runtime/cli-wrapper.py, #7361): separate --provider and -m/--model
...
import { ADAPTER, canRun, runWrapper } from "../helpers/wrapper-harness.ts";

describe.skipIf(!canRun)(
  "packages/nemoclaw-hermes/runtime/cli-wrapper.py provider/model merge",
  () => {
