...
"""Managed tool-broker compatibility for the NemoClaw Hermes plugin.

Hermes loads these patches only when NemoClaw manages vendor tool credentials
through the host broker. The plugin entry point remains in __init__.py.
"""
