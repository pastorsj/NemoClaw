...
export function dcodeRlimitShim(rlimitLib: string): string {
...
export function expectDcodeRlimitHookWarnsWhenVerificationFails(
  hookPath: string,
  rlimitLib: string,
): void {
...
export function expectDcodeRlimitHookWarnsWhenHelperIsMissing(
  hookPath: string,
  rlimitLib: string,
): void {
