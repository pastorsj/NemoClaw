...
} from "../helpers/secret-patterns.ts";

const packageRoot = path.resolve(import.meta.dirname, "../..");
const managedRuntimePath = path.join(packageRoot, "runtime", "managed-runtime.py");
const observabilityPath = path.join(packageRoot, "runtime", "observability.py");
const wrapperPath = path.join(packageRoot, "runtime", "agent-wrapper.sh");
