...
/** Validate and canonicalize the optional secondary-agent configuration. */
export function parseExtraAgentConfig(value: unknown, primaryProvider: string): ExtraAgentsPayload {
...
/** Place the canonical primary agent before every validated secondary agent. */
export function buildOpenClawAgentList(
  extras: JsonObject[],
