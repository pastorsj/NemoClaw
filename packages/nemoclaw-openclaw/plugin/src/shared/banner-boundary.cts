...
// both the OpenClaw plugin and NemoClaw CLI are built.
...
// plugin/src/banner.ts for plugin/src/index.ts. Keeping one renderer
...
// regressionTest: plugin/src/shared/banner-boundary.test.ts covers the
