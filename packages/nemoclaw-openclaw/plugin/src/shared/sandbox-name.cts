...
// consumers: The ESM plugin runner (plugin/src/blueprint/runner.ts) and
// migration snapshot (plugin/src/blueprint/snapshot.ts) import the generated
...
// regressionTest: plugin/src/shared/sandbox-name.test.ts plus the plugin
