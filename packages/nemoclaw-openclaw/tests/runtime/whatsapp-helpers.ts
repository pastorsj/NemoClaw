...
// Test harness helpers for whatsapp-compact.test.ts. The Module._load hook
...
import { resolvePatchedModule } from "../../messaging/runtime/whatsapp/runtime/whatsapp-qr-compact";
