...
describe("Pi inference configuration adapter", () => {
  it("explicitly refuses runtime mutation of its generated model catalog", () => {
    const reason = "The sandbox image generates the Pi model catalog. Re-onboard to change it.";
