...
describe("DeepSeek Harness inference configuration adapter", () => {
  it("explicitly refuses runtime mutation of its image-owned Fabric route", () => {
    const reason = "The sandbox image owns its Fabric route. Re-onboard to change it.";
