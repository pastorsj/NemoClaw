...
Open `packages/nemoclaw-openclaw/policy-additions.yaml` and add or modify endpoint entries.
</AgentOnly>
<AgentOnly variant="hermes">
Open `packages/nemoclaw-hermes/policy-additions.yaml` and add or modify endpoint entries.
</AgentOnly>
<AgentOnly variant="deepagents">
Open `packages/nemoclaw-langchain-deepagents-code/policy-additions.yaml` and add or modify endpoint entries.
</AgentOnly>
