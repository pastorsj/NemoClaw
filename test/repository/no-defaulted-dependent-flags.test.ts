...
describe("scanned source path selection", () => {
  it("scans source TypeScript under src and packages/nemoclaw-openclaw/plugin/src", () => {
    expect(isScannedSourcePath("src/commands/sandbox/channels/status.ts")).toBe(true);
    expect(isScannedSourcePath("packages/nemoclaw-openclaw/plugin/src/commands/example.ts")).toBe(true);
  });
