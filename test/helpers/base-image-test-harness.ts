...
export function makeAgent(overrides: Partial<AgentDefinition> = {}): AgentDefinition {
  return {
    ...
    phoneHomeHosts: [],
    dockerfileBasePath: path.join(TEST_REPOSITORY_ROOT, "packages/nemoclaw-hermes/Dockerfile.base"),
    dockerfilePath: path.resolve(import.meta.dirname, "../../packages/nemoclaw-hermes/Dockerfile"),
