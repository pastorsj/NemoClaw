...
test(
  ...
  async ({ artifacts, cleanup, host, lifecycle, progress, sandbox }) => {
    await artifacts.target.declare({
      ...
      boundary:
        "exact candidate CLI and published all-agent managed-image digests through real Docker, OpenShell, native and public Fabric agent turns, restart recovery, and exact cleanup",
