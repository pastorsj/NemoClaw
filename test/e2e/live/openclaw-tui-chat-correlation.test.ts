...
//     test/packages/nemoclaw-openclaw/openclaw-tui-chat-correlation.test.ts so the live test is
...
function buildLiveReproScript(): string {
  // Verbatim port of the script in test/packages/nemoclaw-openclaw/openclaw-tui-chat-correlation.test.ts
...
// helper from test/packages/nemoclaw-openclaw/openclaw-tui-chat-correlation.test.ts.
