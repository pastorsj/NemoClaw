...
const HERMES_TOOL_GATEWAY_RUNTIME_FILES = Object.freeze([
  ...
  Object.freeze({
    key: "brokerCredentials",
    relativePath: "host/broker-credentials.ts",
    maxBytes: 128 * 1024,
  }),
  Object.freeze({
    key: "cloneControl",
    relativePath: "host/clone-control.ts",
    maxBytes: 64 * 1024,
  }),
  Object.freeze({
    key: "requestProxy",
    relativePath: "host/request-proxy.ts",
    maxBytes: 64 * 1024,
  }),
  Object.freeze({
    key: "matrix",
  ...
  return crypto
    ...
    .update(
      JSON.stringify({
        ...
        brokerCredentials: "host/broker-credentials.ts",
        brokerCredentialsSha256: HERMES_TOOL_GATEWAY_RUNTIME.fileHashes.brokerCredentials,
        cloneControl: "host/clone-control.ts",
        cloneControlSha256: HERMES_TOOL_GATEWAY_RUNTIME.fileHashes.cloneControl,
        requestProxy: "host/request-proxy.ts",
        requestProxySha256: HERMES_TOOL_GATEWAY_RUNTIME.fileHashes.requestProxy,
