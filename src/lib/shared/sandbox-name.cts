...
// consumers: The ESM plugin runner (packages/nemoclaw-openclaw/plugin/src/blueprint/runner.ts) and
// migration snapshot (packages/nemoclaw-openclaw/plugin/src/blueprint/snapshot.ts) import the generated
...
// regressionTest: src/lib/shared/sandbox-name.test.ts plus the plugin
