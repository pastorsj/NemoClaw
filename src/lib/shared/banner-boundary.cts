...
// packages/nemoclaw-openclaw/plugin/src/banner.ts for packages/nemoclaw-openclaw/plugin/src/index.ts. Keeping one renderer
...
// regressionTest: src/lib/shared/banner-boundary.test.ts covers the
