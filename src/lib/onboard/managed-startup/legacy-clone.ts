...
export const legacyStartupCloneDependencies = {
 ...
 */
export interface LegacyStartupCloneState {
...
export interface LegacyStartupCloneInput {
  ...
  readonly currentSource: LegacyStartupCloneState;
}

export interface LegacyReboundManagedStartupClone {
...
export class LegacyStartupCloneError extends Error {
...
function fail(message: string, cause?: unknown): never {
  throw new LegacyStartupCloneError(message, cause === undefined ? undefined : { cause });
}
...
function currentInference(
  ...
  current: LegacyStartupCloneState,
...
function currentMessagingPlan(current: LegacyStartupCloneState): unknown | null {
...
function reconcileCurrentSourceProfile(
  ...
  if (profile.agent === "openclaw") {
    ...
    if (
      ...
      contextWindow = legacyStartupCloneDependencies.resolveContextWindowForModel(
 ...
 */
export function rebindLegacyManagedStartupProfileForClone(
  input: LegacyStartupCloneInput,
): LegacyReboundManagedStartupClone {
  ...
  try {
    ...
    if (error instanceof LegacyStartupCloneError) throw error;
