...
import type { HarnessPackageAuthority } from "../agent-runtime/package/types";
...
export interface SandboxCreateIntent {
  ...
  readonly recreateTransaction?: {
    ...
    readonly harnessPackage: import("../agent-runtime/package/types").HarnessPackageIdentity | null;
  };
