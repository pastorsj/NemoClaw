...
const googleChatProviderProfile: MessagingBridgeProfile = {
  channelId: "googlechat",
  agent: "openclaw",
  profilePath: `${process.cwd()}/packages/nemoclaw-openclaw/provider-profiles/googlechat.yaml`,
      ...
      [
        {
          ...
          messagingProviderProfile: googleChatProviderProfile,
        },
      ],
      {},
      deps.runOpenshell,
