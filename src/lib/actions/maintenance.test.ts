...
describe("backupAll", () => {
  ...
  it("rejects package loss after lock acquisition before container or backup mutation", async () => {
  ...
  it("restores a started container when package authority changes before backup", async () => {
    mocks.listSandboxes.mockReturnValue({
      sandboxes: [{ name: "sb-stopped", openshellDriver: "docker" }],
      defaultSandbox: null,
    });
