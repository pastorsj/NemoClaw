...
const mocks = vi.hoisted(() => ({
  ...
  assertMcpCommandRuntimeAvailable: vi.fn(),
...
vi.mock("./mcp-bridge-runtime-capabilities", async (importOriginal) => {
  const actual = await importOriginal<typeof import("./mcp-bridge-runtime-capabilities")>();
  return {
    ...actual,
    assertMcpCommandRuntimeAvailable: mocks.assertMcpCommandRuntimeAvailable,
  };
});
