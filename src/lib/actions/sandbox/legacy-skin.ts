...
/** Preserve the terminal-skin shim only for sandboxes created before package receipts. */
export function prepareLegacyHermesLightSkin(
  sandboxName: string,
  sandbox: SandboxEntry | null | undefined,
  agent: ConnectAgent,
  env: NodeJS.ProcessEnv,
): void {
  if (hasHarnessPackageAuthority(sandbox ?? null)) return;
