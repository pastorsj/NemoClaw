...
function enabledPluginId(render: PluginRender): string | null {
...
/** Add package-rendered plugin entries to the runtime's existing allow list. */
export function allowRenderedPlugins(
  config: JsonObject,
  renderEntries: readonly PluginRender[],
): void {
