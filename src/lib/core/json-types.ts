 ...
 *
 * Note: The plugin (`packages/nemoclaw-openclaw/plugin/src/`) has its own parallel types
...
export type { UnknownRecord } from "../shared/object-record";

// Keep the established JSON-boundary imports stable while the shape checks
// themselves live in the shared object-record module.
export { isObjectRecord, isPlainObject } from "../shared/object-record";
